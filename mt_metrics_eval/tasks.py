...
def WMT23(lps: list[str] | None = None, primary=True, k=0, gold=None, only_seg_level=False, item_for_seg_level_pearson=False, only_pearson=False):
  ...
  weights = [len(lps)] + [1] * (len(tasks) - 1) if not only_seg_level else [1] * len(tasks)
